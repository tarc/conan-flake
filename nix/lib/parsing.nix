{ ... }:
{
  parseSystemArch =
    ...
    in
    if num != 3 then
      throwImpl (error "#components (${toString num}) != 3")
    else
      let
      ...
      if s == "x86_64" then
        "x86_64"
      else if s == "aarch64" then
        (aarch64Select s)
      else if s == "armv7l" then
        (armv7lSelect s)
      else if s == "i686" then
        "x86"
      else if s == "armv6l" then
        "armv6"
      else if s == "riscv64" then
        "riscv64"
      else if s == "powerpc64le" then
        "ppc64le"
      else
        throwImpl (error "Unknown architecture: ${s}");
